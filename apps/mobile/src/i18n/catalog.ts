...
const messages: Record<Locale, Record<MessageKey, string>> = {
  en: {
    ...
    'map.mapUnavailable': 'The map is unavailable. Switch to the area list to browse delayed community activity.',
    ...
    'report.hub.step.safety': 'Visibility',
    ...
    'report.wizard.continueToSafety': 'Continue to visibility',
    'report.wizard.safetyIntro': 'Choose how this report is shared.',
    'report.wizard.riskNormal': 'Share approximate area',
    'report.wizard.riskSensitive': 'Share tomorrow',
    'report.wizard.riskCritical': 'Keep report private',
    'report.wizard.riskNormalConsequence': 'The approximate area appears after at least 2 hours.',
    'report.wizard.riskSensitiveConsequence': 'The approximate area appears after at least 24 hours.',
    'report.wizard.riskCriticalConsequence': 'This report stays off the public map and feed.',
    'report.wizard.continueToArea': 'Continue to area',
    'report.wizard.areaIntro': 'Where did you see the cat?',
    ...
    'report.wizard.devicePending': 'Current location ready. Only an approximate area will be shown publicly.',
    'report.wizard.manualSelected': 'Area selected.',
    ...
    'report.wizard.reviewIntro': 'Ready to share? Check the details below.',
    ...
    'report.wizard.areaMapLabel': 'Choose a coarse area on the map',
  ...
  'zh-CN': {
    ...
    'map.mapUnavailable': '地图暂不可用。请切换到区域列表浏览延迟显示的社区活动。',
    ...
    'report.wizard.continueToSafety': '继续到公开范围',
    'report.wizard.safetyIntro': '选择这份报告的公开范围。',
    'report.wizard.riskNormal': '公开大致区域',
    'report.wizard.riskSensitive': '明天再公开',
    'report.wizard.riskCritical': '报告不公开',
    'report.wizard.riskNormalConsequence': '大致区域至少延迟 2 小时公开。',
    'report.wizard.riskSensitiveConsequence': '大致区域至少延迟 24 小时公开。',
    'report.wizard.riskCriticalConsequence': '这份报告不会出现在公开地图与动态中。',
    ...
    'report.wizard.devicePending': '已获取当前位置。公开地图只显示大致区域。',
    'report.wizard.manualSelected': '已选择目击区域。',
    ...
    'report.wizard.reviewIntro': '请确认照片、猫咪状态和目击地点，点击编辑可修改。',
    ...
    'report.wizard.areaMapLabel': '在地图上选择宽泛区域',
...
export type TabRoute = 'index' | 'map' | 'report' | 'discuss' | 'profile';
...
export function getTabDefinitions(locale: Locale): TabDefinition[] {
  if (locale === 'zh-CN') {
    return [
      ...
      { route: 'discuss', label: '社区', accessibilityLabel: '社区动态与讨论' },
  ...
  return [
    ...
    { route: 'discuss', label: 'Community', accessibilityLabel: 'Community feed and discussions' },
