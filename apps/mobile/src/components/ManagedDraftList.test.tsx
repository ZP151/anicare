...
it('confirms a batch, excludes pending items and retains failed deletions',async()=>{
 ...
 await fireEvent.press(v.getByLabelText('Select'));await fireEvent.press(v.getByLabelText('Select all'));await fireEvent.press(v.getByLabelText('Delete selected'));
...
it('stops a batch after owner change and suppresses repeated confirmation dialogs',async()=>{
 ...
 await fireEvent.press(v.getByLabelText('Select'));await fireEvent.press(v.getByLabelText('Select all'));
