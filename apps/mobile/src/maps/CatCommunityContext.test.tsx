...
import {neighbourhoodForPublicCell} from '@animalhelper/domain';
const id='00000000-0000-4000-8000-000000000102';
beforeEach(()=>{jest.clearAllMocks();});
it('shows named community activity and navigates with a neighbourhood ID or cat ID only',async()=>{
 ...
 await fireEvent.press(await view.findByText(/^Tampines › /));expect(mockPush).toHaveBeenCalledWith(`/map?communityId=${neighbourhoodForPublicCell('896526add03ffff')!.id}`);
