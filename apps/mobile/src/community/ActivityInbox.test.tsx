...
const mockList=jest.fn(),mockMark=jest.fn(),mockPush=jest.fn(),mockPin=jest.fn();
...
beforeEach(()=>{jest.clearAllMocks();mockOwner='owner-a';mockPin.mockImplementation(()=>{const owner=mockOwner;return async()=>mockOwner===owner;});mockList.mockResolvedValue({items:[],nextCursor:null});mockMark.mockResolvedValue(undefined);});
