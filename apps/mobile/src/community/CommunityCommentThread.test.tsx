...
beforeEach(()=>{jest.clearAllMocks();mockAccountFailed=false;mockOwner='owner-a';mockList.mockResolvedValue({items:[reply(parentId,'Parent comment')],nextCursor:null});mockCreate.mockResolvedValue('00000000-0000-4000-8000-000000000012');});
