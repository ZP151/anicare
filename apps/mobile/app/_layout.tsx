...
function LocalizedStack() {
  ...
  return <Stack screenOptions={{ headerShown: true, headerBackTitle: cn ? '返回' : 'Back' }}>
        ...
        <Stack.Screen name="following" options={{ headerShown: false, title: cn ? '关注' : 'Following' }} />
        <Stack.Screen name="report/index" options={{ headerShown: false }} />
        <Stack.Screen name="report/new" options={{ headerShown: false }} />
        <Stack.Screen name="report/receipt" options={{ headerShown: false, title: cn ? '报告回执' : 'Report receipt' }} />
        <Stack.Screen name="report/my-reports" options={{ headerShown: false, title: cn ? '我的报告' : 'My reports' }} />
        <Stack.Screen name="report/redaction-review" options={{ headerShown: false, presentation: 'modal' }} />
        <Stack.Screen name="care/[id]" options={{ headerShown: false, title: cn ? '照护记录' : 'Care records' }} />
        <Stack.Screen name="care/my-care" options={{ headerShown: false, title: cn ? '我的照护' : 'My care' }} />
        <Stack.Screen name="privacy" options={{ headerShown: false, title: cn ? '隐私与请求' : 'Privacy and requests' }} />
        <Stack.Screen name="safety/[id]" options={{ headerShown: false, title: cn ? '内容安全' : 'Content safety' }} />
        ...
        <Stack.Screen name="messages/example" options={{ headerShown: false }} />
