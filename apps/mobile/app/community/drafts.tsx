...
export default function SocialDrafts(){
 ...
 return <ScreenScaffold pinHeading title={zh?'帖子草稿':'Post drafts'} trailing={<Pressable accessibilityRole="button" accessibilityLabel={zh?'关闭':'Close'} style={{minWidth:44,minHeight:44,justifyContent:'center'}} onPress={()=>router.canGoBack()?router.back():router.replace('/' as never)}><AppIcon name="close" color={c.ink}/></Pressable>}>
