...
export default function FollowingScreen(){
 ...
 return <ScreenScaffold collapseTitle leading={<BackButton onPress={()=>router.canGoBack()?router.back():router.replace('/profile' as never)}/>} title={cn?'关注':'Following'} subtitle={cn?'重新打开猫档案，查看照护记录。':'Return to cat profiles and read care records.'}>
