...
2026-09-09 增量：新增官方邻里层、金文泰 / 西海岸入口及正式 App icon。[邻里与图标归档](docs/design/ios26-neighbourhood-v4/index.html)保存原始资源与实际网页回归截图；地图底图和 Liquid Glass 仍以真机为准。[官方依据与实现](docs/plans/2026-09-09-neighbourhoods-and-app-icon.md)。
